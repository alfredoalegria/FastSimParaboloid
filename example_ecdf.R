...
for(j in 1:nrep){
  ...
  e=ecdf(df$component2);
  plot(e,col="lightblue",cex=0.1,xlim=c(-3,3),ylim=c(0,1),main="",
        ylab=ylab,cex.lab=1.3,cex.axis=1.3);
  par(new=T)
}
curve(pnorm(x),lwd=3,xlim=c(-3,3),ylim=c(0,1),main="",
                ylab=ylab,cex.lab=1.3,cex.axis=1.3);
